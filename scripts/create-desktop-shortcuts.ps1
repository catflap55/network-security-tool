...
$s.Arguments = "-NoProfile -ExecutionPolicy Bypass -File `"$(Join-Path $RepoRoot 'Start-Security-Console.ps1')`""
...
$t.Arguments = "-NoProfile -ExecutionPolicy Bypass -File `"$(Join-Path $RepoRoot 'Stop-Security-Console.ps1')`""
